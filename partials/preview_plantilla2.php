								...
								<div id="template-grid">
										...
										<div class="device-grid-wrapper">
												<div class="template-grid device-grid">
														...
														<figure class="grid-item left device tablet" id="tablet_plantilla2">
																<a class="hover-trigger" href="http://plantilla2.jaus.com.mx/" target="_blank" name="Card"></a>
																<div class="device-hardware"></div>
																<div class="hover-mask">
																		<a href="http://plantilla2.jaus.com.mx/" target="_blank">
														...
														<figure class="grid-item device monitor">
																...
																<div class="hover-mask">
																		<a href="http://plantilla2.jaus.com.mx/" target="_blank" name="Focus">
														...
														<figure class="grid-item right device laptop" id="laptop_plantilla2">
																<a class="hover-trigger" href="http://plantilla2.jaus.com.mx/" target="_blank" name="Vanguard" data-id="563899bde4b01c4506da423d" data-reactid=".0.$=1$grid.2.1.$563899bde4b01c4506da423d.0"></a>
														...
														<figure class="grid-item device phone">
																<a class="hover-trigger" href="http://plantilla2.jaus.com.mx/" target="_blank" name="Broadcast" data-id="563895a8e4b0351e292a2b31" data-reactid=".0.$=1$grid.2.1.$563895a8e4b0351e292a2b31.0"></a>
