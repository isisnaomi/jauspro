...
<!--favicon-->
<link rel="icon" href="http://fotos.crminmobiliario.com/jausplus/widgets_js/img/favicon.ico" type="image/jaus-icon">
...
<div class="">
  ...
  <div class="header">
    ...
    <!-- Intro -->
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4 text-center pb50">
          <a href="/index.php"><img class="logo" src="http://www.jaus.com.mx/images/logo-JAUS-pagina-web-inmobiliaria.png" title="JAUS - TU INMOBILIARIA EN INTERNET" /></a>
        </div>
      </div>
      <div class="row">
		...
		<!-- Aerolus Template -->
    <div class="section" style="background-color:#1565C0;">
			<!-- Version 1 -->
          ...
          <div class="col-sm-10 col-sm-offset-1">
            <div class="col-sm-4">
              <h4 class="template-description">
                <ul>
                  <li>Header Simple</li>
                  <li>Carrusel de Inmuebles</li>
        ...
        <div class="row">
          <div class="col-sm-4 col-sm-offset-4 text-center pt20">
            <a href="#boreas" class="slide-down-button" role="button"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
					</div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4 text-center pt20">
          <a href="#cronus" class="slide-down-button" role="button"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4 text-center pt20">
          <a href="#plantilla_a" class="slide-down-button" role="button"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
        </div>
      </div>
    ...
    <div class="section">
			<div class="row pb50">
				<div class="col-sm-10 col-sm-offset-1 text-center">
						<h2 class="template-section-name" >M&aacute;s Plantillas</h2>
					</div>
				</div>
